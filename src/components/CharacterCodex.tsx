    ...
    <div className="fixed inset-0 z-50 flex justify-end bg-black/70 backdrop-blur-sm no-print" onClick={onClose}>
      <aside
        ...
        style={{
          ...
          boxShadow: `-12px 0 40px ${c.shadow || "rgba(0,0,0,0.45)"}`
        }}
      ...
      >
        ...
        >
          <div>
            <div className="mono text-[10px] tracking-[0.18em] uppercase" style={{ color: c.clash || c.muted }}>
        ...
        <div className="px-5 py-3 flex gap-2 border-b" style={{ borderColor: c.border }}>
          ...
          {activeId && (
            <button
              ...
              style={{ borderColor: c.clash || c.border, backgroundColor: c.card, color: c.clash || c.text }}
            >
              Save as New
            </button>
          )}
        ...
        <div className="flex-1 overflow-y-auto px-5 pb-6 space-y-2.5">
          {filtered.length === 0 ? (
            ...
            >
              <BookMarked className="w-6 h-6 mx-auto mb-2" style={{ color: c.clash || c.accent }} />
              {entries.length === 0
              ...
              return (
                <article
                  ...
                  style={{
                    ...
                    borderColor: active ? (c.clash || c.borderStrong) : c.border,
                    boxShadow: active ? `0 0 0 1px ${c.clash || c.borderStrong}` : "none"
                  }}
                >
                  <div
                    className="w-14 h-[4.5rem] rounded-xl overflow-hidden border shrink-0"
                    style={{ borderColor: c.border, backgroundColor: c.bg2 }}
                  >
                    {entry.portraitUrl ? (
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      {active && (
                        <span
                          className="mono text-[9px] px-1.5 py-0.5 rounded border shrink-0"
                          style={{ borderColor: c.clash || c.borderStrong, color: c.clash || c.accent }}
                        >
                          LOADED
                        </span>
                      )}
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-2">
                      ...
                      {confirmId === entry.id ? (
                        <button
                          ...
                          className="px-2.5 h-7 rounded-lg text-[10px] font-bold"
                          style={{ backgroundColor: c.clash || "#be123c", color: c.clashText || "#fff" }}
                        >
                          Confirm delete
                        </button>
                      ) : (
